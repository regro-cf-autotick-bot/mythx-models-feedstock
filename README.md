...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mythx-models-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12343&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mythx-models-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mythx-models` can be installed with:

```
conda install mythx-models
```

It is possible to list all of the versions of `mythx-models` available on your platform with:
